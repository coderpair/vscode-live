...
function t(t) {
    ...
    this.modelData = this.monaco._modelData;
    ...
    t.prototype.applyOperation = function (t) { t.isNoop() || (this.ignoreChanges = !0);
        ...
        t.ops.forEach(function (t) {
            if (t.isRetain())
                ...
                r.monaco.executeEdits("my-source", [{ range: new monaco.Range(n.lineNumber, n.column, n.lineNumber, n.column), text: t.text, forceMoveMarkers: !0 }],null,r.modelData), e += t.text.length
            } else if (t.isDelete()) {
                var i = r.monacoModel.getPositionAt(e),
                o = r.monacoModel.getPositionAt(e + t.chars);
		        log1(r.monacoModel.uri.path);
                r.monaco.executeEdits("my-source", [{ range: new monaco.Range(i.lineNumber, i.column, o.lineNumber, o.column), text: "", forceMoveMarkers: !0 }],null,r.modelData)
            }
        }),
        this.lastDocLines = this.monacoModel.getLinesContent(),
        this.ignoreChanges = !1
